module.exports = (function (r) {
      ...
      return (
        ...
        (o.mark = function (e) {
          return (
            Object.setPrototypeOf
              ...
              : ((e.__proto__ = v), n in e || (e[n] = 'GeneratorFunction')),
        ...
        (O.prototype = {
          ...
          abrupt: function (e, t) {
            ...
            return (
              (o.type = e), (o.arg = t), a ? ((this.method = 'next'), (this.next = a.finallyLoc), y) : this.complete(o)
            )
          },
  ...
  function (e, t, r) {
    ...
    function g(e) {
      for (
        var t = arguments.length - 1, r = 'https://reactjs.org/docs/error-decoder.html?invariant=' + e, n = 0;
        n < t;
        n++
      )
    ...
    function D(e, t, r) {
      var n = void 0,
        ...
        i = null
      if (null != t)
        for (n in (void 0 !== t.ref && (i = t.ref), void 0 !== t.key && (o = '' + t.key), t))
      ...
      return { $$typeof: f, type: e, key: o, ref: i, props: a, _owner: j.current }
    }
    function _(e) {
      ...
      return null == e
        ...
        : (function e(t, r, n, a) {
            ...
            if (((i = 0), (r = '' === r ? '.' : r + ':'), Array.isArray(t)))
              ...
              for (t = s.call(t), u = 0; !(o = t.next()).done; ) i += e((o = o.value), (s = r + F(o, u++)), n, a)
            else
              'object' === o &&
                g(
                  '31',
                  '[object Object]' == (n = '' + t) ? 'object with keys {' + Object.keys(t).join(', ') + '}' : n,
                  '',
                )
            return i
          })(e, '', t, r)
    ...
    var A = {
        ...
        cloneElement: function (e, t, r) {
          ...
          if (1 === (n = arguments.length - 2)) a.children = r
          else if (1 < n) {
            s = Array(n)
  ...
  function (e, t, r) {
    ...
    function O(e) {
      ...
      return pe.a.createElement(
        'label',
        { className: 0 < y.length ? a : n, style: 0 < y.length ? u : i },
        0 < y.length ? d : p,
          ...
          f()(t, [
            {
              ...
              value: function () {
                ...
                return (
                  g && (R = ''.concat(R, ', ').concat(D(g))),
                  'error_file_size' === v || 'error_validation' === v
                    ? pe.a.createElement(
                        'div',
                        { className: t, style: n },
                        pe.a.createElement('span', { className: 'dzu-previewFileNameError' }, R),
                        'error_file_size' === v &&
                          pe.a.createElement('span', null, y < C ? 'File too small' : 'File too big'),
                        'error_validation' === v && pe.a.createElement('span', null, String(b)),
                        S &&
                          pe.a.createElement('span', { className: 'dzu-previewButton', style: q.remove, onClick: u }),
                      )
                    : (('error_upload_params' !== v && 'exception_upload' !== v && 'error_upload' !== v) ||
                        (R = ''.concat(R, ' (upload failed)')),
                      'aborted' === v && (R = ''.concat(R, ' (cancelled)')),
                      pe.a.createElement(
                        'div',
                        { className: t, style: n },
                        h && pe.a.createElement('img', { className: r, style: a, src: h, alt: R, title: R }),
                        !h && pe.a.createElement('span', { className: 'dzu-previewFileName' }, R),
                        pe.a.createElement(
                          'div',
                          ...
                          'uploading' === v &&
                            x &&
                            pe.a.createElement('span', { className: 'dzu-previewButton', style: q.cancel, onClick: i }),
                          'preparing' !== v &&
                            'getting_upload_params' !== v &&
                            'uploading' !== v &&
                            S &&
                            pe.a.createElement('span', { className: 'dzu-previewButton', style: q.remove, onClick: u }),
                          ['error_upload_params', 'exception_upload', 'error_upload', 'aborted', 'ready'].includes(v) &&
                            E &&
                ...
                return C.a.wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          t.preventDefault(), t.stopPropagation(), (e.next = 4), E.getDataTransferItemsFromEvent()(t)
                        )
                      case 4:
                        ;(r = e.sent), E.setState({ active: !0, dragged: r })
                      case 6:
                      case 'end':
                        return e.stop()
                    }
                ...
                return C.a.wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 9:
                        if (E.files.length >= l)
                          return (v.meta.status = 'rejected_max_files'), E.handleChangeStatus(v), e.abrupt('return')
                        e.next = 13
                        break
                      case 13:
                        if (
                  ...
                  function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        ...
                        case 22:
                          for (
                            y = new XMLHttpRequest(), h = new FormData(), y.open(u, o, !0), v = 0, g = Object.keys(l);
                            v < g.length;
                            v++
                          )
                            ...
                            y.addEventListener('readystatechange', function () {
                              ;(2 !== y.readyState && 4 !== y.readyState) ||
                                (0 === y.status &&
                                  ...
                                  ((t.meta.status = 'exception_upload'), E.handleChangeStatus(t), E.forceUpdate()),
                                0 < y.status &&
                                  y.status < 400 &&
                                  ((t.meta.percent = 100),
            ...
            value: function () {
              ...
              return (
                D
                  ...
                  : C && ((se = ''.concat(se, ' ').concat(I)), (ce = fe()({}, ce || {}, {}, H || {}))),
